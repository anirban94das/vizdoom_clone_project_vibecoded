"""Small desktop UI to launch training for a chosen ViZDoom scenario.

Wraps the existing train_basic.py / train_deadly_corridor.py entry points as
...
this machine has 8 physical cores).
